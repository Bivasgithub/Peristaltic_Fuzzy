...
function Cf = c1 (z, A2, A3, A4, A6, Da, Gr, eta, W_s, Q, Rd, Br, Fr, M, Re, lambda11, dp_by_dz)
...
Cf = c1 (z, A2, A3, A4, A6, Da, Gr, eta, W_s, Q, Rd, Br, Fr, M, Re, lambda11, dp_by_dz);
% Cf = vpa(Cf, 6);
% disp(Cf);
% plot(z, Cf, '-', 'LineWidth', 2)
% hold on;
 bar(Cf);
 hold on;
end